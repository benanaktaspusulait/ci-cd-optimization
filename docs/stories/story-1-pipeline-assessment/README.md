...
|------|-------|:---:|:--------:|--------|
| T1.1 | [Review .drone.star pipeline structure](./task-1-review-drone-star.md) | M | Must | Not started |
| T1.2 | [Identify local vs RepoSync boundaries](./task-2-local-vs-central.md) | S | Must | Not started |
| T1.3 | [Map CI steps, DIND and Compose usage](./task-3-map-ci-steps.md) | M | Must | Not started |
| T1.4 | [Assess Testcontainers feasibility in Drone](./task-4-testcontainers-feasibility.md) | M | Must | Not started |
| T1.5 | [Assess BuildKit/cache feasibility](./task-5-buildkit-feasibility.md) | S | Should | Not started |
