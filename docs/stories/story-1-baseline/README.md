...
|------|-------|:---:|:--------:|--------|
| T1.1 | [Select pilot repository/service](./task-1-select-repo.md) | S | Must | Not started |
| T1.2 | [Capture CI/CD pipeline baseline](./task-2-pipeline-baseline.md) | M | Must | Not started |
| T1.3 | [Capture Docker build & image-size baseline](./task-3-build-image-baseline.md) | S | Must | Not started |
| T1.4 | [Capture integration-test baseline](./task-4-integration-test-baseline.md) | M | Must | Not started |
