# E2-S1.4 — Deliver the CD Target Transition
...
| **Depends on** | Current CD pipeline/configuration access, platform/release owners and explicit approval before migration changes |
...
3. **Implementation:** only after the target is approved, implement the agreed pipeline/chart/configuration changes through their durable owner routes.
...
- [ ] No migration change begins before target, owner, rollout and rollback approval are recorded.
