...
- Epic 2 contains one story with five outcome-focused SNS and CD transition tasks.
...
| Redis, Kafka and Schema Registry | [Epic 2 — Testcontainers infrastructure task](./epic-2-post-pilot-delivery/story-1-deliver-and-validate/task-2-testcontainers-infrastructure.md); non-Redis implementation requires new evidence |
| Compose application/helper topology and Kafdrop/Jaeger/LocalStack candidates | [Epic 2 — full integration-topology task](./epic-2-post-pilot-delivery/story-1-deliver-and-validate/task-3-e2e-compose-topology.md); no automatic migration or removal |
| CI validation and adoption of approved SNS changes | [Epic 2 — CI validation/adoption task](./epic-2-post-pilot-delivery/story-1-deliver-and-validate/task-4-ci-validation-adoption.md) |
| `kd`/Helm, PVC lifecycle and legacy CD components | [Epic 2 — CD transition task](./epic-2-post-pilot-delivery/story-1-deliver-and-validate/task-5-cd-transition.md) |
