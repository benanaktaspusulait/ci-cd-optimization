...
| Field | Value |
|-------|-------|
| **Status** | Done (estimates — pending Drone UI + local build confirmation) |
| **Date** | 2026-06-11 |
...
| Task | File | Status |
|------|------|:------:|
| T2.1 — Select pilot repo | [T2.1-select-repo.md](./T2.1-select-repo.md) | ✅ |
...
1. **Pilot repo:** `fdp-cmd-adaptor-sns` — representative, low-risk, portable patterns
