...
| Detailed Task Definitions | Index for all 23 task definitions, split by story |
...
| Tasks — Story 5 | Docker Compose Rationalisation (T5.1–T5.3) |
| Tasks — Story 6 | Findings, Ownership & Recommendations (T6.1–T6.3) |
