...
These decisions are scoped to the pilot and may be revisited as evidence emerges or platform capabilities change (e.g., ACP providing BuildKit remote cache).
...
**Status:** Accepted (pilot scope — one dependency)
...
**Status:** Accepted (local validation; remote cache requires ACP)
